...
Per exemple, podem utilitzar \texttt{gnuplot} per representar els punts que obtenim en avaluar un polinomi amb \texttt{paval}. Prenem per exemple el polinomi $f(x) = x^2 - 3x + 2$ en els punts $x \in [0.1, 0.3]$ amb pas $0.1$. Aleshores, obtindrem:
\begin{figure}[h]
\centering
\begin{gnuplot}[terminal=epslatex, terminaloptions={color dashed}]
set size ratio -1
plot "< ( echo '2 2 -3 1' ; seq 0 .01 3 ) | ./paval" with lines title "$f(x) = x^2 - 3x + 2$"
\end{gnuplot}
\caption{}
\end{figure}
